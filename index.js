...
const client = new Client({
  phoneNumber: '584263374753', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
    { name: "VA", lid: "584263374753@lid", jid: "584263374753@s.whatsapp.net" },
  // Owner 2
    { name: "emam", lid: "584263374753@lid", jid: "584263374753@s.whatsapp.net" },
  // Owner 3
    { name: "Sukuna", jid: "584263374753@s.whatsapp.net", lid: "584263374753@lid" },
  // Owner 4 
   { name: "عمورتي", jid: "584263374753@s.whatsapp.net", lid: "584263374753@lid" }
  ],
